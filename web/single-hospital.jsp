...
<!--  <div id="topbar" class="d-flex align-items-center fixed-top">
  ...
  <!-- ======= Slider Section ======= -->
  <%@include file="hospital/slider.jsp" %>
  <!-- End Slider -->
  ...
  <main id="main">
    ...
    <!-- ======= Appointment Section ======= -->
    <%@include file="hospital/appointment.jsp" %>
   <!-- End Appointment Section -->

    <!-- ======= Departments Section ======= -->
    <%@include file="hospital/departments.jsp" %>
   ...
   <!-- End Testimonials Section -->
    ...
    <!-- ======= Doctors Section ======= -->
    <%@include file="hospital/doctors.jsp" %>
    <!-- End Doctors Section -->
    ...
    <!-- ======= Contact Section ======= -->
    <%@include file="hospital/contact.jsp" %>
    <!-- End Contact Section -->
  ...
  <%@include file="hospital/footer.jsp" %>
 <!-- End Footer -->
